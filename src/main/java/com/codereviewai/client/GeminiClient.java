...
public class GeminiClient implements AIClient {
    ...
    public List<CodeReviewResult> reviewCode(String fileContent) throws Exception {
        ...
        String jsonPayload = "{\"contents\":[{\"parts\":[{\"text\":" + mapper.writeValueAsString(prompt) + "}]}],\"generationConfig\":{\"responseMimeType\":\"application/json\"}}";
        ...
        String rawLlmJson = rootNode.at("/candidates/0/content/parts/0/text").asText();
